...
let cenarios = [
  ...
  {
    label_ptBR: "01 - Espaço Sideral (ES)", //nome do cenário em português BR
    label_enUS: "01 - Outer Space (OS)", //nome do cenário em inglês US
...
{
    label_ptBR: "02 - Equilíbrio Indiferente (EInd)", //nome do cenário
    label_enUS: "02 - Indifferent Equilibrium (IndE)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "03 - Oscilador Ideal (OI)", //nome do cenário
    label_enUS: "03 - Ideal Oscillator (IO)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "04 - Processo Subamortecido (PSub)", //nome do cenário
    label_enUS: "04 - Underdampened Process (UndP)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "05 - Processo c/ Amort. Crítico (PCrit)", //nome do cenário
    label_enUS: "05 - Critically-dampened Process (CritP)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "06 - Processo Superamortecido (PSuper)", //nome do cenário
    label_enUS: "06 - Overdampened Process (OverP)", //nome do cenário em inglês US
...
{
    label_ptBR: "07 - Pêndulo Invertido (PInv)", //nome do cenário
    label_enUS: "07 - Inverted Pendulum (InvP)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "08A - PInv: Transição Rápida", //nome do cenário
    label_enUS: "08A - InvP: Fast Transition", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "08B - Idem Acima: Por Que o Alarme é Acionado?", //nome do cenário
    label_enUS: "08B - Same as Above: Why is the Alarm Triggered?", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "09 - PCrit: Estabilização", //nome do cenário
    label_enUS: "09 - CritP: Stabilization", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "10 - PCrit: Estabilização (2)", //nome do cenário
    label_enUS: "10 - CritP: Stabilization (2)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "11 - PCrit: Comparação Biestável/Proporcional", //nome do cenário
    label_enUS: "11 - CritP: Bistable/Proportional Comparison", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12A - PSub: Sistema de Controle Desligado", //nome do cenário
    label_enUS: "12A - UndP: Control System Off", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12B - PSub: Biestável", //nome do cenário
    label_enUS: "12B - UndP: Bistable", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12C - PSub: P", //nome do cenário
    label_enUS: "12C - UndP: P", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12D - PSub: P + D (sem filtro)", //nome do cenário
    label_enUS: "12D - UndP: P + D (no filter)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12E - PSub: P + D (com filtro)", //nome do cenário
    label_enUS: "12E - UndP: P + D (with filter)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12F - PSub: PID", //nome do cenário
    label_enUS: "12F - UndP: PID", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12G - PSub: PI", //nome do cenário
    label_enUS: "12G - UndP: PI", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12H - PSub: PD + I (se \|SP-PV\| < 2m)", //nome do cenário
    label_enUS: "12H - UndP: PD + I (if \|SP-PV\| < 2m)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12I - PSub: PD + I (se \|D\| < 20%)", //nome do cenário
    label_enUS: "12I - UndP: PD + I (if \|D\| < 20%)", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12J - PSub: PID c/ tempo morto = 0,5ms", //nome do cenário
    label_enUS: "12J - UndP: PID w/ deadtime = 0.5s", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "12K - PSub: PID c/ 10% folga motor linear", //nome do cenário
    label_enUS: "12K - UndP: PID w/ 10%-backlashed linear motor", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "13 - PSuper: Comparação Anti-windup", //nome do cenário
    label_enUS: "13 - OverP: Anti-windup Comparison", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
/*
{
    label_ptBR: "14 - ES: Transição Quase Estática", //nome do cenário
    label_enUS: "14 - OS: Quasi-static Transition", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,

    // parâmetros do motor linear
    Fcmax: 1e3, // valor absoluto da máxima força aplicável (tração/compressão) pelo motor linear (unidades SI)

    // parâmetros do processo a ser controlado
    m: 5000, //massa do carrinho em unidades SI
    K_mola: 0, // constante da mola em unidades SI (pode ser negativa para simular pêndulo invertido)
    C_amortecedor: 0, // coeficiente de amortecimento SI (pode ser negativa)
    posicao_inicial: -10, // valor inicial da posição x do carrinho em relação à origem (unidades SI)
    velocidade_inicial: 0, // velocidade inicial do carrinho (SI)
    perturbacao_Tipo: 6, // 0-nenhuma, 1-onda senoidal, 2-onda quadrada, 3-onda triangular, 4-dente de serra, 5-trem de impulsos, 6-ruido aleatório, 7-manual
    perturbacao_manual_inicial: -5, // habilitado no modo manual (% de Fcmax), limitado aos valores de perturbacao_Fmax e perturbacao_Fmin
    perturbacao_Fmax: 0, // valor máximo da perturbação (% de Fcmax)
    perturbacao_Fmin: -10, // valor mínimo da perturbação (% de Fcmax)
    perturbacao_Periodo: 15, // periodo da perturbação (unidades SI)
    perturbacao_t_on: 93, // percentual do periodo da onda de perturbação em nível máximo (para onda quadrada)
    ...
    estado_inicial_controlador: 0, //0-DESL., 1-controle AUTO, 2-controle MANUAL
    tipo_controlador: 2, //0-Controlador PID, 1-Controlador PD + I se e<eLim, 2-Controlador PD + I se D<DLim, 3- Controlador Biestável
    Kp: 1e-10, // ganho da componente proporcional (adimensional) - Obs. Kp=0 desativa o PID sem inibir a pré-carga OP0
    Ki: 0.5,  // ganho da componente integral (adimensional) - Ki precisa ser nulo para habilitar a pré-carga OP0
    Kd: 50, // ganho da componente derivativa (adimensional)
    OP0: 0, //pré-carga em % de OP (de -100 a 100) (adimensional)
    Imax: 100, //valor máximo em % da componente integral
    eLim: 1.5, //limiar para integração no modo PD+I se erro<eLim
    DLim: 15, //era 1 limiar para integração no modo PD+I se D<DLim
    modo_acao_controlador: 0, // 0-Ação Reversa, 1- Ação Direta
    Fc_manual_inicial: -100, // valor inicial % de OP (de -100 a 100) do modo MAN
    setpoint_Tipo: 0, // 0-MANUAL, 1-onda senoidal, 2-onda quadrada, 3-onda triangular, 4-dente de serra, 5-trem de impulsos, 6-ruido aleatório
    setpoint_Periodo: 300, // periodo do setpoint se for selecionada uma onda (unidades SI)
    setpoint_t_on: 50, // percentual do periodo da onda do setpoint em nível máximo (onda quadrada)
    setpoint_manual_inicial: 10, // valor inicial do setpoint quando é selecionado o setpoint manual (unidades SI)
    elimina_surto_derivativo: 1, // 0-função desabilitada, 1-função habilitada
    ativa_filtro_passa_baixa: 1, // 0-filtro desabilitado, 1-filtro habilitado
...
{
    label_ptBR: "14 - EInd: Elemento Final c/ Folga", //nome do cenário
    label_enUS: "14 - IndE: Backlashed Final Element", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
...
{
    label_ptBR: "15 - PSub: Questão NRC P319", //nome do cenário
    label_enUS: "15 - UndP: NRC Question P319", //nome do cenário em inglês US
    // expressar valores decimais com ponto . em vez de vírgula ,
    ...
    // parâmetros do processo a ser controlado
    m: 5000, //massa do carrinho em unidades SI
    K_mola: 3000, // constante da mola em unidades SI (pode ser negativa para simular pêndulo invertido)
    C_amortecedor: 3000, // coeficiente de amortecimento SI (pode ser negativa)
    posicao_inicial: -10, // valor inicial da posição x do carrinho em relação à origem (unidades SI)
    velocidade_inicial: 2, // velocidade inicial do carrinho (SI)
    perturbacao_Tipo: 2, // 0-nenhuma, 1-onda senoidal, 2-onda quadrada, 3-onda triangular, 4-dente de serra, 5-trem de impulsos, 6-ruido aleatório, 7-manual
    perturbacao_manual_inicial: -60, // habilitado no modo manual (% de Fcmax), limitado aos valores de perturbacao_Fmax e perturbacao_Fmin
